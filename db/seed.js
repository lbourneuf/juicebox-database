...
async function testDB() {
  try {
    ...
    console.log("Calling getAllPostsById");
    const albertId = await getPostById(1);
    console.log("Get Post Id Result: ", albertId);

    console.log("Calling get PostsByUser");
    const postByUser = await getPostsByUser(1);
    console.log("Get post by user Result", postByUser);
    ...
    console.log("Posts with happy result: ", postsWithHappy);
